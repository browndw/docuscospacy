...
**docuscospacy works with Python 3.9 or newer (tested up to Python 3.10).** It also requires `spacy >= 3.3 <https://spacy.io/usage>`_ and `tmtoolkit >= 0.11 <https://tmtoolkit.readthedocs.io/en/latest/>`_
